    ...
    <div class="row">
      <div class="col-md-4 mb-5">
        <div class="card h-100">
          <img class="card-img-top" src="../assets/mangos/img1.jpg" alt="" style="width:350px; height:200px;">
          <div class="card-body">
      ...
      <div class="col-md-4 mb-5">
        <div class="card h-50">
          <img class="card-img-top" src="../assets/mangos.jpg" alt="" style="width:350px; height:200px;">
        </div>
      </div>
      <div class="col-md-4 mb-5">
        <div class="card h-100">
